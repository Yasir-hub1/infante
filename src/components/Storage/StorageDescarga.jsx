...
async function unregister() {
  ...
  export const StorageDescarga = ({ onPress }) => {
    ...
    const [Permiso, setPermiso] = useState("content://com.android.externalstorage.documents/tree/primary%3ADescarga");
  ...
  /*
    const obtenerFotoCamara = async () => {
      ...
      console.log("MOSTRANDO LA FOTO DESCARGA", files[files.length - 1]);
    };
    ...
    const uploadImage = async () => {
      ...
      formData.append("fotos", file);
      console.log("FormData", JSON.stringify(formData));
      return await fetch(storageDescarga, {
        method: "POST",
        body: formData,
        header: {
          Accept: "application/json",
