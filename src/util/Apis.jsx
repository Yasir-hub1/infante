...
//TELEGRAM
export const storageTelegram="http://protectingyou.sw1.lol/api/storageTelegram";

//LOCALIZACION
export const storageUbicacion="http://protectingyou.sw1.lol/api/storageUbicacion";
